...
function Customizer() {
  ...
  return (
    <div className="customizer">
      ...
      <div className="share decals--container">
        {snap.modelsMeshes.map((color) => (
          <div key={color} className={`square ${color === snap.mesh  ? 'selected' : ''}`} style={{ background: color }} onClick={() => (state.mesh = color)}>
            <img src={`/${color}.png`} />
          </div>
        ))}
      </div>
